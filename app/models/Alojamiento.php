...
class Alojamiento
{
    ...
    public function findById($id)
    {
        $query = "SELECT a.*,
                         ...
                         pc.codigo as politica_codigo, pc.nombre as politica_nombre, pc.descripcion as politica_descripcion,
                  ...
                  LEFT JOIN politica_casa pc ON a.politica_casa_id = pc.politica_casa_id
    ...
    public function create($datos)
    {
        $query = "INSERT INTO alojamiento (
                    codigo, titulo, tipo_codigo, numero_habitaciones, numero_banios,
                    tamanio_m2, genero_exclusivo_codigo, mascotas_permitidas, fumadores_permitidos,
                    descripcion, usuario_id, politica_casa_id, ubicacion_id, direccion,
        ...
        $stmt->bindParam(':numero_banios', $datos['numero_banios'], PDO::PARAM_INT);
        $stmt->bindParam(':tamanio_m2', $datos['tamanio_m2']);
        ...
        $stmt->bindParam(':politica_casa_id', $datos['politica_casa_id']);
    ...
    public function update($id, $datos)
    {
        $query = "UPDATE alojamiento SET
                    ...
                    numero_habitaciones = :numero_habitaciones, numero_banios = :numero_banios,
                    tamanio_m2 = :tamanio_m2, genero_exclusivo_codigo = :genero_exclusivo_codigo,
                    mascotas_permitidas = :mascotas_permitidas, fumadores_permitidos = :fumadores_permitidos,
                    descripcion = :descripcion, usuario_id = :usuario_id, politica_casa_id = :politica_casa_id,
